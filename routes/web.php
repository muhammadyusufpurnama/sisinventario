...
//route CRUD
Route::get('/pegawai','App\Http\Controllers\PegawaiController1@index');
Route::get('/pegawai/tambah','App\Http\Controllers\PegawaiController1@tambah');
Route::post('/pegawai/store','App\Http\Controllers\PegawaiController1@store');
Route::get('/pegawai/edit/{id}','App\Http\Controllers\PegawaiController1@edit');
Route::post('/pegawai/update','App\Http\Controllers\PegawaiController1@update');
Route::get('/pegawai/hapus/{id}','App\Http\Controllers\PegawaiController1@hapus');
